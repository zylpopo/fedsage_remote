...
class Classifier:
    def __init__(self,hasG:StellarGraph,
                 all_classes,
                 has_node_subjects:Series,acc_path:str,classifier_path:list,downstream_task_path:str, train_test_split=None):
        ...
        if train_test_split is not None:
            self.train_subjects = train_test_split[0]
            self.test_subjects = train_test_split[1]
        else:
        ...
        self.train_targets = preprocessing.label_binarize(self.train_subjects, classes=all_classes)
